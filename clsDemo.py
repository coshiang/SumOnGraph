...
if __name__ == '__main__':
    ...
    for file_path in file_list:
        try:
            ...
            file_name_list.append(file_name + ' PageRank')
            dict_scores_list.append(score)
            ...
            file_name_list.append(file_name + ' betweenness_centrality')
            dict_scores_list.append(score)
            ...
            file_name_list.append(file_name + ' closeness_centrality')
            dict_scores_list.append(score)
            # -------------------------------- closeness_centrality ----------------------------------------
            ...
            file_name_list.append(file_name + ' degree_centrality')
            dict_scores_list.append(score)
            # -------------------------------- degree_centrality ----------------------------------------
